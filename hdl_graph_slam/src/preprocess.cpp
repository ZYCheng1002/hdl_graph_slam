...
void Preprocess::process(const hdl_graph_slam::CustomMsg::ConstPtr& msg, PointCloudXYZI::Ptr& pcl_out) {
  avia_handler(msg);
  *pcl_out = pl_surf;
}
...
void Preprocess::avia_handler(const hdl_graph_slam::CustomMsg::ConstPtr& msg) {
  pl_surf.clear();
  pl_corn.clear();
  pl_full.clear();
