...
class FrontLioNodelet : public nodelet::Nodelet {
 public:
  FrontLioNodelet(){}
  virtual ~FrontLioNodelet() {}
...
PLUGINLIB_EXPORT_CLASS(hdl_graph_slam::FrontLioNodelet, nodelet::Nodelet)